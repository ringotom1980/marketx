...
class RunTaifexNightPipeline extends Command
{
    protected $signature = 'market:taifex-night-pipeline';

    protected $description = 'Refresh TAIFEX night session and global influence scores.';
    ...
    public function handle(): int
    {
        ...
        $this->info('TAIFEX night pipeline completed.');
